                            ...
                            <ul>
                                <li class="current-list-item"><a href="#">Home</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('/slider-home') }}">Slider Home</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                                        ...
                                        <span
                                            class="ml-2 font-weight-bold text-primary">{{ Auth::user()->name }}</span>
                                    </a>


                                    <!-- Dropdown Menu -->
                                    <div class="dropdown-menu dropdown-menu-right shadow-lg border-0 rounded"
                                        aria-labelledby="profileDropdown">
                                        <!-- Profile -->
                                        <a class="dropdown-item d-flex align-items-center py-2"
                                            href="{{ route('home') }}">
                                            <i class="fas fa-user text-primary mr-3" style="font-size: 1.2rem;"></i>
                                        ...
                                        <form method="POST" action="{{ route('logout') }}" class="mb-0">
                                            ...
                                            <button type="submit"
                                                ...
                                                <i class="fas fa-sign-out-alt mr-3" style="font-size: 1.2rem;"></i>
                                                <span>Logout</span>
                                            </button>
                                        </form>
                                    </div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html">
								<img src="{{ asset('assets/img/products/product-img-2.jpg') }}" alt="">
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html">
								<img src="{{ asset('assets/img/products/product-img-3.jpg') }}" alt="">
							</a>
						</div>
